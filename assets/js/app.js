/* r9: remove excel UI; hardcode load; keep scroll-to-end; enforce two-up voice layout */
...
window.addEventListener('DOMContentLoaded', ()=>{
  ...
  // Hardcoded load of the default Excel on startup
  loadExcel();
